 ...
 *  \f$ \Sigma_t \f$.
 *  The equation of the EKF routine are defined with the "update_filter"
 *  function.
 *
...
public:
  ...
  */
  ...
  /*!< discretized/discrete covariance of the process noise \f$ R_{t,disc}/R_t \f$ */
  Eigen::MatrixXd proc_noise_disc_;
  /*!< user input covariance of the measure noise \f$ Q_t \f$ */
  Eigen::MatrixXd meas_noise_;
  /*!< covariance of the process noise \f$ Q_t \f$ assuming a discrete measurement */
