...
#include <kalman_filter_templates/EKF.h>
...
public:
  ...
  // This constructor allows you to construct SimpleEKFState from Eigen expressions
  ...
  Eigen::Matrix<double, 1, 1> getState(){return *this;}
...
public:
  ...
  SimpleEKFMeasure(void):
    Eigen::Matrix<double, 1, 1>(),
    meas_pos_(this->head<1>())
  {}

  // This constructor allows you to construct SimpleEKFMeasure from Eigen expressions
  template<typename OtherDerived>
...
public:
  ...
  void update(Eigen::Matrix<double, 1, 1> pos,
              bool new_measured_value){
  ...
  void subscribe_to_data_collector(data_collection::DataCollector& data_collector){
...
private:
   ...
   */
  Eigen::Matrix<double, N, 1> processModel(
      SimpleEKFState &s){
   ...
   */
  Eigen::Matrix<double, K, 1> measModel(
      SimpleEKFState &s){
